...
class MultilingualCVGenerator:
        ...
        return {
            "SK": LanguageContent(
                ...
                sections={
                    ...
                    "safety_management": "Bezpečnosť a Rizikové Manažérstvo",
                ...
                achievements=[
                    ...
                    {
                        "title": "Vedenie Viacerých Tímov",
                        "description": "Trénoval mužské, ženské a juniorské reprezentačné tímy",
                        "impact": "Univerzálne vedenie rôznych skupín športovcov",
                        "year": "1992-2023",
                        "category": "Vedenie"
                    }
                ],
                skills=[
                    ...
                    {
                        "skill": "Medzinárodné Súťaže",
                        "proficiency": "Expert",
                        "description": "Rozsiahle skúsenosti v prostredí Svetového pohára, Olympijských hier a Majstrovstiev",
                        "category": "Súťaže"
                    },
                    {
                        "skill": "Multilingválna Komunikácia",
                        "proficiency": "Pokročilé",
                        "description": "Schopnosť efektívne pracovať v medzinárodnom prostredí",
            ...
            "DE": LanguageContent(
                ...
                sections={
                    ...
                    "safety_management": "Sicherheits- und Risikomanagement",
                ...
                achievements=[
                    ...
                    {
                        "title": "Multi-Team-Führung",
                        "description": "Trainierte Männer-, Frauen- und Junioren-Nationalmannschaften",
                        "impact": "Vielseitige Führung verschiedener Athletengruppen",
                        "year": "1992-2023",
                        "category": "Führung"
                    }
                ],
                skills=[
                    ...
                    {
                        "skill": "Internationale Wettbewerbe",
                        "proficiency": "Experte",
                        "description": "Umfangreiche Erfahrung in Weltcup-, Olympia- und Meisterschaftsumgebungen",
                        "category": "Wettbewerb"
                    },
                    {
                        "skill": "Mehrsprachige Kommunikation",
                        "proficiency": "Fortgeschritten",
                        "description": "Fähigkeit, effektiv in internationalen Umgebungen zu arbeiten",
            ...
            "SP": LanguageContent(
                ...
                sections={
                    ...
                    "safety_management": "Gestión de Seguridad y Riesgos",
                ...
                achievements=[
                    ...
                    {
                        "title": "Liderazgo Multi-Equipo",
                        "description": "Entrenó equipos nacionales masculinos, femeninos y junior",
                        "impact": "Liderazgo versátil en diferentes grupos de atletas",
                        "year": "1992-2023",
                        "category": "Liderazgo"
                    }
                ],
                skills=[
                    ...
                    {
                        "skill": "Competición Internacional",
                        "proficiency": "Experto",
                        "description": "Extensa experiencia en entornos de Copa del Mundo, Olímpicos y Campeonatos",
                        "category": "Competición"
                    },
                    {
                        "skill": "Comunicación Multilingüe",
                        "proficiency": "Avanzado",
                        "description": "Capacidad para trabajar efectivamente en entornos internacionales",
    ...
    def generate_improved_html_cv(self, language_code: str) -> str:
        """Generate improved HTML CV for specific language"""
...
def main():
    ...
    for lang in languages:
        html_cv = generator.generate_improved_html_cv(lang)
